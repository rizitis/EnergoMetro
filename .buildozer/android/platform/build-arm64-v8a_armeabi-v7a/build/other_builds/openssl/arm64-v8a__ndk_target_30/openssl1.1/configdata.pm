...
our %config = (
  ...
  CFLAGS => [ "-target aarch64-linux-android30 -fomit-frame-pointer -march=armv8-a -fPIC" ],
  CPPDEFINES => [ "__ANDROID_API__=30" ],
  CPPFLAGS => [ "-DANDROID -I/home/omen/.buildozer/android/platform/android-ndk-r25b/toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/include -I/home/omen/GITHUB/SofoRevma/.buildozer/android/platform/build-arm64-v8a_armeabi-v7a/build/python-installs/SofoRevma/arm64-v8a/include/python3.1" ],
  CPPINCLUDES => [  ],
  CXX => "/usr/bin/ccache /home/omen/.buildozer/android/platform/android-ndk-r25b/toolchains/llvm/prebuilt/linux-x86_64/bin/clang++ -target aarch64-linux-android30 -fomit-frame-pointer -march=armv8-a -fPIC",
  CXXFLAGS => [ "-target aarch64-linux-android30 -fomit-frame-pointer -march=armv8-a -fPIC" ],
  ...
  libdir => "",
  major => "1",
  makedepprog => "\$(CROSS_COMPILE)aarch64-linux-android30-clang",
  minor => "1.1",
  ...
  perl_version => "5.38.2",
  perlargv => [ "shared", "no-dso", "no-asm", "android-arm64", "-D__ANDROID_API__=30" ],
  perlenv => {
